              ...
              <Reveal width="100%" delay={0.6}>
                <div className="flex flex-wrap gap-4 items-center md:items-start justify-center md:justify-start mb-8 max-w-2xl">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-fit px-6 py-3 bg-gradient-to-r from-red-900/30 to-orange-900/30 border border-red-500/50 rounded-full font-bold transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(249,115,22,0.4)] hover:shadow-[0_0_35px_rgba(249,115,22,0.7)] hover:scale-105 group gelly-button text-xs md:text-sm shrink-0 animate-pulse"
                  >
                    <span className="font-black bg-gradient-to-r from-red-500 via-orange-500 to-yellow-400 text-transparent bg-clip-text bg-[length:200%_auto] animate-text-gradient tracking-widest drop-shadow-[0_0_10px_rgba(249,115,22,0.8)] whitespace-nowrap">
                      CHECK MY RESUME
                    </span>
                    <FileText size={18} className="text-orange-500 group-hover:text-yellow-400 drop-shadow-[0_0_10px_rgba(249,115,22,0.8)] transition-colors" />
                  </a>
                </div>
              </Reveal>
            </div>
