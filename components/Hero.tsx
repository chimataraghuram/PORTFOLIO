...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen md:h-screen flex items-start md:items-center justify-center pt-28 md:pt-32 pb-24 md:pb-0 relative overflow-hidden" style={{ paddingBottom: 'calc(5rem + env(safe-area-inset-bottom, 0px))' }}>
      {/* Background Shapes */}
            ...
            <div>
              ...
              <Reveal width="100%" delay={0.6}>
                <div className="flex flex-wrap gap-4 items-center md:items-start justify-center md:justify-start mb-8 max-w-2xl">
                  ...
                  <a
                    href="https://portfolio-cr-gold.vercel.app/"
                    target="_blank"
                    rel="noreferrer"
