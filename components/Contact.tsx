        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Reveal width="100%" delay={0.1}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="block group relative h-full w-[90%] mx-auto max-w-md sm:w-full sm:mx-0"
            >
              <div className="h-full bg-slate-900/40 backdrop-blur-3xl backdrop-saturate-150 p-6 sm:p-10 rounded-xl border border-white/10 group-hover:border-blue-500/50 hover:scale-[1.02] transition-all duration-500 flex flex-col items-center text-center gelly-card shadow-2xl group-hover:shadow-blue-500/20">
                ...
                <span className="mt-auto relative px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full overflow-hidden gelly-button group/btn border border-blue-500/30">
                  ...
                  <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-indigo-400 font-black tracking-widest text-[10px] sm:text-xs uppercase group-hover/btn:text-white transition-all">View Profile</span>
                </span>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal width="100%" delay={0.2}>
            ...
            >
              <div className="h-full bg-slate-900/40 backdrop-blur-3xl backdrop-saturate-150 p-6 sm:p-10 rounded-xl border border-white/10 group-hover:border-white/30 hover:scale-[1.02] transition-all duration-500 flex flex-col items-center text-center gelly-card shadow-2xl group-hover:shadow-white/10">
                ...
                <span className="mt-auto relative px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full overflow-hidden gelly-button group/btn border border-white/20">
                  ...
                  <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-slate-200 to-zinc-300 font-black tracking-widest text-[10px] sm:text-xs uppercase group-hover/btn:text-white transition-all">Explore Repos</span>
                </span>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal width="100%" delay={0.3}>
            ...
            >
              <div className="h-full bg-slate-900/40 backdrop-blur-3xl backdrop-saturate-150 p-6 sm:p-10 rounded-xl border border-white/10 group-hover:border-sky-400/50 hover:scale-[1.02] transition-all duration-500 flex flex-col items-center text-center gelly-card shadow-2xl group-hover:shadow-sky-400/20">
                ...
                <span className="mt-auto relative px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full overflow-hidden gelly-button group/btn border border-sky-500/30">
                  ...
                  <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-blue-300 to-cyan-400 font-black tracking-widest text-[10px] sm:text-xs uppercase group-hover/btn:text-white transition-all">Join Channel</span>
                </span>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal width="100%" delay={0.4}>
            <a
              ...
              className="block group relative h-full w-[90%] mx-auto max-w-md sm:w-full sm:mx-0"
            >
              <div className="h-full bg-slate-900/40 backdrop-blur-3xl backdrop-saturate-150 p-6 sm:p-10 rounded-xl border border-white/10 group-hover:border-red-400/50 hover:scale-[1.02] transition-all duration-500 flex flex-col items-center text-center gelly-card shadow-2xl group-hover:shadow-red-500/20">
                ...
                <h3 className="text-xl sm:text-2xl font-black mb-2 sm:mb-3 uppercase tracking-tight bg-gradient-to-r from-[#4285F4] via-[#EA4335] via-[#FBBC05] to-[#34A853] text-transparent bg-clip-text bg-[length:200%_auto] animate-text-gradient">Gmail</h3>
                <p className="text-gray-400 text-xs sm:text-sm mb-6 sm:mb-8 leading-relaxed">Direct business inquiries & collaborations</p>
                <span className="mt-auto relative px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full overflow-hidden gelly-button group/btn">
                  ...
                  <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-red-300 to-yellow-400 font-black tracking-widest text-[10px] sm:text-xs uppercase group-hover/btn:text-white transition-all">Send Email</span>
                </span>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal width="100%" delay={0.5}>
            ...
            >
              <div className="h-full bg-slate-900/40 backdrop-blur-3xl backdrop-saturate-150 p-6 sm:p-10 rounded-xl border border-white/10 group-hover:border-green-500/50 hover:scale-[1.02] transition-all duration-500 flex flex-col items-center text-center gelly-card shadow-2xl group-hover:shadow-green-500/20">
                ...
                <span className="mt-auto relative px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full overflow-hidden gelly-button group/btn border border-green-500/30">
                  ...
                  <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-300 to-lime-400 font-black tracking-widest text-[10px] sm:text-xs uppercase group-hover/btn:text-white transition-all">Visit Hub</span>
                </span>
              </div>
            </a>
          </Reveal>
