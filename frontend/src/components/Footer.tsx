    ...
    <footer className="bg-transparent relative overflow-hidden">
      ...
      <div className="absolute bottom-[-150px] md:bottom-[-200px] inset-x-0 h-[600px] md:h-[800px] pointer-events-none z-0 flex justify-center items-end">
        ...
        <div className="absolute bottom-[30px] w-full h-[800px] flex justify-center items-end overflow-hidden">
          ...
          <motion.div 
            className="absolute bottom-[-400px] md:bottom-[-400px] left-1/2 -translate-x-1/2 w-[800px] md:w-[800px] h-[800px] md:h-[800px] rounded-full bg-[#581c87] blur-[100px] opacity-40 z-10"
          ...
          <motion.div 
            className="absolute bottom-[-135px] md:bottom-[-135px] left-1/2 -translate-x-1/2 w-[270px] md:w-[270px] h-[270px] md:h-[270px] rounded-full border-[35px] border-white blur-[6px] shadow-[0_0_80px_rgba(255,255,255,1),inset_0_0_40px_rgba(255,255,255,1)] z-40"
          ...
          <motion.div 
            className="absolute bottom-[-100px] md:bottom-[-100px] left-1/2 -translate-x-1/2 w-[200px] md:w-[200px] h-[200px] md:h-[200px] rounded-full bg-[#581c87] shadow-[0_0_50px_rgba(168,85,247,1)] blur-[2px] z-50"
          ...
          <motion.div
            className="absolute bottom-[-100px] md:bottom-[-100px] left-1/2 -translate-x-1/2 w-[200px] md:w-[200px] h-[200px] md:h-[200px] rounded-full border-[4px] border-[#c084fc] blur-[4px] z-50"
        ...
        <motion.div 
          className="absolute bottom-[28px] left-1/2 -translate-x-1/2 w-[110%] max-w-[800px] h-[80px] bg-gradient-to-t from-[#a855f7] to-transparent blur-[20px] opacity-80 z-30"
        ...
        <motion.div 
          className="absolute bottom-[0px] left-1/2 -translate-x-1/2 w-[200%] h-[100px] bg-gradient-to-r from-transparent via-[#7c3aed] to-transparent blur-[40px] z-20 opacity-80"
        ...
        <motion.div 
          className="absolute bottom-[28px] left-1/2 -translate-x-1/2 w-[150%] max-w-[1200px] h-[6px] bg-gradient-to-r from-transparent via-[#a855f7] to-transparent blur-[4px] z-40"
        ...
        <motion.div 
          className="absolute bottom-[29px] left-1/2 -translate-x-1/2 w-[100%] max-w-[600px] h-[4px] bg-gradient-to-r from-transparent via-white to-transparent blur-[2px] shadow-[0_0_20px_rgba(255,255,255,1)] z-50"
        ...
        <motion.div 
          className="absolute bottom-[30px] left-1/2 -translate-x-1/2 w-[100%] max-w-[300px] h-[2px] bg-white shadow-[0_0_10px_rgba(255,255,255,1)] z-50"
