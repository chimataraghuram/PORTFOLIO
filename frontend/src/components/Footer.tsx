      ...
      <div className="absolute bottom-0 inset-x-0 h-[600px] md:h-[800px] pointer-events-none z-0 flex justify-center items-end overflow-hidden">
        ...
        <div className="absolute bottom-0 grid place-items-end justify-items-center w-full z-10">
          ...
          <motion.div 
            ...
            whileInView={{ scale: [1, 1.03, 1], opacity: [0.7, 1, 0.7] }}
          ...
          <motion.div 
            ...
            whileInView={{ scale: [1, 1.02, 1], opacity: [0.8, 1, 0.8] }}
          ...
          <motion.div
            ...
            whileInView={{ scale: [0.8, 1.5, 2], opacity: [0, 0.8, 0] }}
          ...
          <motion.div 
            ...
            style={{ transformOrigin: 'bottom center' }}
            whileInView={{ scale: [1, 3.5], opacity: [0.4, 0] }}
          ...
          <motion.div 
            ...
            style={{ transformOrigin: 'bottom center' }}
            whileInView={{ scale: [1, 4.5], opacity: [0.2, 0] }}
        ...
        <div className="absolute bottom-0 w-full flex justify-center items-end z-30">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: [0.7, 1, 0.7], scaleX: [0.95, 1.05, 0.95] }}
          ...
          <motion.div 
            ...
            whileInView={{ opacity: [0.6, 1, 0.6], scaleX: [0.9, 1.2, 0.9] }}
